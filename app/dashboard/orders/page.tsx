            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-mono text-sm">{selectedOrder.orderId}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-mono text-sm">{selectedOrder.customerId}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Payment Status</label>
              ...
              <div className="border-t pt-4">
                <h3 className="text-lg font-semibold mb-3">Order Amounts</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700">Discounts</label>
                ...
                <div className="border-t pt-4">
                  ...
                  {selectedOrder.refundReason && (
                    <div className="mt-2">
                      ...
                      <p className="text-gray-900">{selectedOrder.refundReason}</p>
                    </div>
                  )}
                </div>
              )}
              ...
              {selectedOrder.commissionAmount && (
                <div className="border-t pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="text-sm font-medium text-gray-700">Basis</label>
                      <p className="text-gray-900">{selectedOrder.commissionBasis?.replace('_', ' ')}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-700">Source</label>
                      <p className="text-gray-900 capitalize">{selectedOrder.commissionSource}</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {selectedOrder.attributedCreatorId && (
                <div className="border-t pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-medium text-gray-700">Creator ID</label>
                      <p className="text-gray-900 font-mono text-sm">{selectedOrder.attributedCreatorId}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-700">Type</label>
                      <p className="text-gray-900 capitalize">{selectedOrder.attributionType}</p>
                    </div>
                    {selectedOrder.attributedCouponCode && (
                      <div>
                        <label className="text-sm font-medium text-gray-700">Coupon Code</label>
                        <p className="text-gray-900 font-mono">{selectedOrder.attributedCouponCode}</p>
                      </div>
                    )}
                    {selectedOrder.referralCode && (
                      <div>
                        <label className="text-sm font-medium text-gray-700">Referral Code</label>
                        <p className="text-gray-900 font-mono">{selectedOrder.referralCode}</p>
                      </div>
                    )}
                  </div>
                </div>
              ...
              {selectedOrder.appliedCoupons && selectedOrder.appliedCoupons.length > 0 && (
                <div className="border-t pt-4">
                  <label className="text-sm font-medium text-gray-700">Applied Coupons</label>
                  ...
                  <div className="space-y-2">
                    {selectedOrder.lineItems.map((item, idx) => (
                      <div key={idx} className="p-3 bg-gray-50 rounded-md">
                        <p className="font-medium">{item.title || `Item ${idx + 1}`}</p>
                        {item.quantity && (
              ...
              <div className="border-t pt-4 grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-gray-900">{formatDateTime(new Date(selectedOrder.createdAt))}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-700">Last Updated</label>
                  <p className="text-gray-900">{formatDateTime(new Date(selectedOrder.updatedAt))}</p>
                </div>
              </div>
            </CardContent>
          </Card>
